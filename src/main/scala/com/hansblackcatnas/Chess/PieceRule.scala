                ...
                case InfoBlack(King, init) => 
                    ...
                    val castlingPositionA = {
                        ...
                        if (
                            ...
                            ) &&
                            {
                                for (i <- forKingRangeW) {
                                    i._2 match {
                                        ...
                                        case a if a contains ExLocation("d8") => castlingPositionABool = false
                            ...
                            {
                                _currentBoard("b8") == InfoNone && _currentBoard("c8") == InfoNone && _currentBoard("d8") == InfoNone
                            }
                            ...
                            ) &&
                            {
                                for (i <- forKingRangeW) {
                                    i._2 match {
                                        ...
                                        case b if b contains ExLocation("e8") => castlingPositionABool = false
                                        case b if b contains ExLocation("f8") => castlingPositionABool = false
                                        case _ => {}
                                    }
                                }
                                castlingPositionABool
                ...
                case InfoWhite(King, init) => {}
                    ...
                    val castlingPositionA = {
                        ...
                        if (
                            ...
                            ) &&
                            {
                                for (i <- forKingRangeB) {
                                    i._2 match {
                                        ...
                                        case a if a contains ExLocation("d1") => castlingPositionABool = false
                            ...
                            {
                                _currentBoard("b1") == InfoNone && _currentBoard("c1") == InfoNone && _currentBoard("d1") == InfoNone
                            }
                            ...
                            ) &&
                            {
                                for (i <- forKingRangeB) {
                                    i._2 match {
                                        ...
                                        case b if b contains ExLocation("e1") => castlingPositionABool = false
                                        case b if b contains ExLocation("f1") => castlingPositionABool = false
                                        case _ => {}
                                    }
                                }
                                castlingPositionABool
